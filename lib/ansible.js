...
Ansible.prototype.install = function(cb) {
  ...
  this.util.exec(_this.ansiblePrefix + ' --extra-vars="install=true"', {
...
Ansible.prototype.configure = function(binaryDirectory, cb) {
  ...
  this.util.exec(_this.ansiblePrefix + ' --extra-vars="configure=true binary_directory=' + binaryDirectory + '"', {
    cwd: path.resolve(__dirname, '../ansible')
  }, function() {
