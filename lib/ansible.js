...
Ansible.prototype.install = function(cb) {
  ...
  this.util.exec(_this.ansiblePrefix + ' --extra-vars="install=true owner=' + _this.owner + ' group=' + _this.group + '"', {
...
Ansible.prototype.configure = function(binaryDirectory, cb) {
  ...
  this.util.exec(_this.ansiblePrefix + ' --extra-vars="configure=true binary_directory=' + binaryDirectory + ' owner=' + _this.owner + ' group=' + _this.group + '"', {
    cwd: path.resolve(__dirname, '../ansible')
  }, function() {
