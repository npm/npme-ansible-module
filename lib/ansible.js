...
Ansible.prototype.install = function(cb) {
  ...
  this.util.exec(_this.ansiblePrefix + ' --extra-vars="install=true npme_owner=' + _this.user + ' npme_group=' + _this.group + '"', {
...
Ansible.prototype.configure = function(binaryDirectory, cb) {
  ...
  this.util.exec(_this.ansiblePrefix + ' --extra-vars="configure=true binary_directory=' + binaryDirectory + ' npme_owner=' + _this.user + ' npme_group=' + _this.group + '"', {
    cwd: path.resolve(__dirname, '../ansible')
  }, function() {
